...
module.exports = function loader(content) {
  ...
  var placeholderQuality = parseInt(config.placeholderQuality, 10) || 20
  // JPEG compression
  ...
  var adapter = config.adapter || require('./sharp')
  ...
  if (config.disable) {
    ...
    return loaderCallback(
      ...
      `module.exports = {
        srcSet: p,
        images: [{ path: p, width: 100, height: 100 }],
        src: p,
  ...
  return img
          ...
          if (config.webp) {
            ...
            promises.push(
              img.resize({
                width,
                // options: adapterOptions,
                options: Object.assign(adapterOptions, {
                  webp: true,
                }),
                mime,
              })
    ...
    .then(function(_ref3) {
      ...
      //   'holder': placeholder
      // }
      // loaderCallback(null, imageSetTmpl)
    })
    .catch(function(err) {
